...
def ok(*args, **kwargs) -> bool:
    ...
    """
    return all(check(result_status=ResultStatus.OK, *args, **kwargs))


def dsq(*args, **kwargs) -> bool:
    ...
    """
    return all(check(result_status=ResultStatus.MISSING_PUNCH, *args, **kwargs))
