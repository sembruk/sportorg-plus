...
* Импорт таблицы участников из буфера обмена как в основной ветке разработки SportOrg

### Исправления

* Исправлены нулевые метки времени при чтении контактных чипов ТаймКонтур
* Исправлено нулевое время финиша при отсутствии отметки на станции финиша 

[Все изменения](https://github.com/sembruk/sportorg-plus/compare/v1.8.0...v1.9.0)

## v1.8.0 - 2026-07-23

### Новое

* Возможность задать функцию проверки результатов в диалоге редактирования дистанции
* Добавлен диалог настройки Таймконтур
* Добавлена колонка "Оплачено"
* Импорт страны из списка участников (Orgeo CSV и IOF XML)
* Обновлён шаблон результатов 1_results_teams.html (добавлены сплиты и отображение по дистанциям)

### Исправления

* Обновление статуса для всех участников одной команды при редактировании
* Исправлен импорт IOF XML
* Исправлен импорт/экспорт wdb

[Все изменения](https://github.com/sembruk/sportorg-plus/compare/v1.7.0...v1.8.0)
